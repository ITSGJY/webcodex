...
fn reload_field_classification_is_exhaustive_and_allowlisted() {
    ...
    changed.mcp_bridge.request_timeout_secs += 1;
    ...
    assert_eq!(
            ...
            "capabilities client_id display_name hostname host_context max_concurrent_jobs mcp_bridge owner poll_interval_ms projects_dir temporary_projects_root quic server_url token transport websocket_connect_timeout_secs"
        );
}
