...
pub(crate) fn coding_agent_start_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "project": {
...
pub(crate) fn coding_agent_observe_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "run_id": {
...
pub(crate) fn coding_agent_cancel_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "run_id": {
