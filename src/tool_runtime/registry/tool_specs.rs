...
impl ToolRuntime {
    pub fn tool_specs(&self) -> Vec<ToolSpec> {
        let declarations = vec![
            ...
            tool_spec(
                "stop_job",
                "Stop a bounded runtime job started through WebCodex. Requires confirm=true, obeys project/session ownership boundaries, and never exposes stdout/stderr bodies.",
                object_schema(with_optional_session_id(vec![
