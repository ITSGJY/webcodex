...
fn tool_definition_runtime_tool_policy_inventory_is_stable() {
    ...
    let expected: &[(&str, &str, &str)] = &[
        ...
        ("list_jobs", "job", "none"),
        ("job_tail", "job", "none"),
        ("replace_in_file", "edit", "current_session_fallback"),
        ("replace_exact_block", "edit", "current_session_fallback"),
        ("insert_before_pattern", "edit", "current_session_fallback"),
        ("insert_after_pattern", "edit", "current_session_fallback"),
        ...
        ("replace_line_range", "edit", "current_session_fallback"),
        ("insert_at_line", "edit", "current_session_fallback"),
        ("delete_line_range", "edit", "current_session_fallback"),
