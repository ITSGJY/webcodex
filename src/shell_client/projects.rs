...
use crate::shell_protocol::{
    ...
    SHELL_CLIENT_CAPABILITY_LSP_READ_ONLY_NAVIGATION, SHELL_CLIENT_CAPABILITY_MCP_BRIDGE,
    SHELL_CLIENT_CAPABILITY_PERSISTENT_SHELL, SHELL_CLIENT_CAPABILITY_PROJECT_LIFECYCLE,
...
pub(super) fn capability_enabled(caps: &ShellClientCapabilities, capability: &str) -> bool {
    match capability {
        ...
        SHELL_CLIENT_CAPABILITY_MCP_BRIDGE => caps.mcp_bridge,
