...
use webcodex_cli::{
    ...
    default_device_name, default_server_paths, discover_named_binary_absolute,
    discover_webcodex_binary, is_systemd_platform, login_usage, logout_usage, ops_agents_usage,
